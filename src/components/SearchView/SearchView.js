...
var SearchView = function (_Component) {
  ...
  function SearchView(props) {
    ...
    _this.clearSearchResults = _this.clearSearchResults.bind(_this)
    _this.clearFilter = _this.clearFilter.bind(_this)
    _this.search = _this.search.bind(_this);
    _this.addBookmark = _this.addBookmark.bind(_this)
    _this.removeBookmark = _this.removeBookmark.bind(_this)
    return _this;
  }

  // TODO: probably should pull out the value within the SearchBar
  SearchView.prototype.toggleDisplayAbstract = function toggleDisplayAbstract(value) {
    this.props.toggleDisplayAbstract(value);
  };


  SearchView.prototype.clearSearchResults = function clearSearchResults(value) {
    this.props.clearSearchResults(value);
  };

  SearchView.prototype.clearFilter = function clearFilter(value) {
  ...
  SearchView.prototype.addBookmark = function addBookmark(value) {
    this.props.addBookmark(value);
  };

  SearchView.prototype.removeBookmark = function removeBookmark(value) {
      ...
      React.createElement(
        ...
        this.props.isSearchComplete || this.props.isSearchPending ? React.createElement(
          ...
          React.createElement(SearchResponseView, {
            ...
            displayAbstract: this.props.displayAbstract,
            setAbstractDisplay : this.props.setAbstractDisplay,
